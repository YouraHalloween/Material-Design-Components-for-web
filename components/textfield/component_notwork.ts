...
//         this.adapter
//         if (this.helperText_) {
//             var initCustomError = this.foundation.adapter.hasAttribute('custom-error');
...
//      */
//     get id() {
//         return this.foundation.adapter.getNativeInput().id;
//     }
...
//             iconButton.replaceIcon = iconButton.root.getAttribute(
//                 'aria-replace'
//             );
//         }
//     }
